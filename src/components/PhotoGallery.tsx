  ...
  const generateArtwork = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your AI-generated artwork description has been created"
      });
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <Textarea
                              id="prompt"
                              placeholder="Describe the artistic style you want... (e.g., 'oil painting with impressionist style', 'watercolor landscape', 'digital art with cyberpunk aesthetics')"
                              value={prompt}
